...
function addSh() {
  ...
  var el = document.createElement('script');
  el.type = 'text/javascript';
  el.src = 'http://shjs.sourceforge.net/sh_main.min.js';
  el.onload = function() {
  ...
  sl.src = 'https://raw.github.com/jasonm/shjs-cucumber-highlighting/master/cucumber.js';

  var sx = document.createElement('script');
  sx.type = 'text/javascript';
  sx.src = 'http://shjs.sourceforge.net/lang/sh_ruby.js';
